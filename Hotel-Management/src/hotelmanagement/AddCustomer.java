...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    JButton b1,b2;
    JComboBox c1;
    Choice c2;//ComboBox is static but choice is not static it is dyanamic
    JRadioButton r1,r2;
    ...
    AddCustomer(){
        ...
        add(l1);
        //sad boy hors bigdaddy
        
        JLabel l2 = new JLabel("Id");
        l2.setBounds(20,80,100,25);
        add(l2);

        c1 = new JComboBox(new String[]{"PassPort","Voter Card","Driving License","Aadhar Card"});
        ...
        l8.setBounds(20,320,100,20);
        add(l8);
        t4 = new JTextField();
        t4.setBounds(200,320,150,20);
        add(t4);
        JLabel l9 = new JLabel("Deposit");
        l9.setBounds(20,360,100,20);
        add(l9);
        t5 = new JTextField();
